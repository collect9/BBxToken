...
abstract contract C9Struct {
    ...
    uint256 constant MSZ_TIMESTAMP = 38;
    ...
    uint256 constant MASK_BALANCER = 2**60-1; // balance, votes, and transfer counter
    uint256 constant MASK_BURNER = 2**40-1; // balance, votes
